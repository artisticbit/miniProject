	...
	<script type="text/javascript">
		...
		$(function(){
			$("input[name='searchKeyword']").on("keyup",function(){
				...
				if($("select[name='searchCondition']").val()=='0'&&inputId!=''){
				
					
					$.ajax({
							url:"/user/json/getUserIds/"+inputId,
							datatype:"json",
							method:"GET",
							success:function(jsonData, status){
								...
								// select: function( event, ui ) {},
						          focus: function( event, ui ) {  $(".ui-helper-hidden-accessible").hide();},
		...
		$(function(){
			...
			$("input[name='searchKeyword']").autocomplete({
			      source: function(request, response){
			    	  $.ajax({
							url:"/user/json/getUserIds/"+request.term,
							datatype:"json",
							method:"GET",
							success:function(jsonData, status){
								response(jsonData);
